  ...
  return (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          'pointer-events-none block h-4 w-4 rounded-full bg-canvas shadow-lg ring-0 transition-transform duration-[var(--motion-uniform)] ease-out will-change-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0 motion-reduce:transition-none'
        )}
      />
    </SwitchPrimitives.Root>
  )
